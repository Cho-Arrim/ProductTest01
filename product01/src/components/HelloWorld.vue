...
<script lang="ts">
import { CameraMechanics } from '@/scripts/CameraMechanics';
...
export default defineComponent({
  ...
  mounted(){
    ...
    //new MeshActions(canvas, loadingBar, percentLoaded, loader);
    new CameraMechanics(canvas, loadingBar, percentLoaded, loader);
  }
});
</script>
